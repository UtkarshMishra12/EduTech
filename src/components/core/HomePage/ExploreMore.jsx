    ...
    return(
        <div>
            ...
            <p className="text-richblack-300 text-center text-sm text-[16px] mt-3">
                Learn to build anything you can imagine with our hands-on coding courses.
            </p>
                      ...
                      <div
                        className={` text-[16px] flex flex-row items-center gap-2 ${
                          currentTab === element
                            ...
                            : "text-richblack-200"
                        } px-7 py-[2px] rounded-full transition-all duration-200 cursor-pointer hover:bg-richblack-900 hover:text-richblack-5`}
                        key={index}
            ...
            <div className="lg:absolute gap-10 justify-center lg:gap-0 flex lg:justify-between flex-wrap w-full lg:bottom-[0] lg:left-[50%] lg:translate-x-[-50%] lg:translate-y-[50%] text-black lg:mb-0 mb-10 lg:px-0 px-3">
                {
                    courses.map( (element, index) => {
                        return(
                            <Card key={index} cardData={element} currentCard={currentCard} setCurrentCard={setCurrentCard}/>
                        )
                    })
